 ...
 * @return {boolean|*}
 */
AcEventWrapper.prototype.setFetchNodeMode = function (mode, fetchInvisibleNode, fetchNotImportantNode) {
    if (acEventWrapper == null) {
        return null;
    }
    return acEventWrapper.setFetchNodeMode(mode, fetchInvisibleNode, fetchNotImportantNode);
};
