 ...
 * @return {@link NodeInfo} {NodeInfo 对象|null}
 */
...
function setFetchNodeMode(mode, fetchInvisibleNode, fetchNotImportantNode) {
    if (isAccMode()) {
        return acEvent.setFetchNodeMode(mode, fetchInvisibleNode, fetchNotImportantNode);
    } else if (isAgentMode()) {
        return agentEvent.setFetchNodeMode(mode, fetchInvisibleNode, fetchNotImportantNode);
    }
    return false;
}
